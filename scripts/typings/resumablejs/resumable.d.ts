//***** Importnant *****//
/*
This file has been changed from the downloaded version by AltSource to work in a non-modual (standard browser) environment.
*/
...
declare class Resumable extends resumable.Resumable {}
