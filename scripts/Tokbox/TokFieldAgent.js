var tok;
(function (tok) {
    var TokFieldAgent = /** @class */ (function () {
        function TokFieldAgent() {
            var _this = this;
            this.apiKey = 0;
            this.init = function () {
                _this.OT = window.OT;
                ...
                $.get(_this.urlManager.GetApiKey()).then(function (apiKey) {
                    _this.apiKey = apiKey;
        ...
        return TokFieldAgent;
    }());
    tok.TokFieldAgent = TokFieldAgent;
    window.tokFieldAgent = new TokFieldAgent();
})(tok || (tok = {}));
//# sourceMappingURL=TokFieldAgent.js.map